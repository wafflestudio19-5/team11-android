...
@HiltViewModel
class MyArticleBoardViewModel @Inject constructor(
    ...
    fun getArticleList(offset: Int, limit: Int, interest: String) {
        viewModelScope.launch{
            try{
                ...
                _articleList.value = service.getMyArticle(offset, limit, interest).results!!
                _listSize.value = service.getMyArticle(offset, limit, interest).count
            } catch (e: IOException) {
                Timber.e(e)
            }
        }
